...
from apps.skills.views import SkillGraphView, SkillNextStepView, SkillPathToView, SkillViewSet
...
urlpatterns = [
    ...
    path('skills/from-text/', IngestSkillsFromTextView.as_view(), name='skills-from-text'),
    path('skills/<int:skill_id>/next-step/', SkillNextStepView.as_view(), name='skill-next-step'),
    path('skills/<int:skill_id>/resources/', SkillResourcesView.as_view(), name='skill-resources'),
    path('skills/<int:from_id>/path-to/<int:to_id>/', SkillPathToView.as_view(), name='skill-path-to'),
